      ...
      for (const shopifyOrder of linkedOrders) {
        ...
        await db
          ...
          .set({
            ...
            shippingName: internalOrderData.shippingName,
            shippingPhone: internalOrderData.shippingPhone,
            shippingAddress1: internalOrderData.shippingAddress1,
            shippingAddress2: internalOrderData.shippingAddress2,
            shippingCity: internalOrderData.shippingCity,
            shippingState: internalOrderData.shippingState,
            shippingZip: internalOrderData.shippingZip,
            shippingCountry: internalOrderData.shippingCountry,
            shippingCompany: internalOrderData.shippingCompany,
            billingName: internalOrderData.billingName,
            billingPhone: internalOrderData.billingPhone,
            billingAddress1: internalOrderData.billingAddress1,
            billingAddress2: internalOrderData.billingAddress2,
            billingCity: internalOrderData.billingCity,
            billingState: internalOrderData.billingState,
            billingZip: internalOrderData.billingZip,
            billingCountry: internalOrderData.billingCountry,
            billingCompany: internalOrderData.billingCompany,
            updatedAt: new Date(),
          })
